...
export default function AccessibilityControls(){
  ...
  const buttonClass = 'min-h-10 rounded-md border px-3 py-2 text-xs font-bold uppercase tracking-wide transition focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300'

  return (
    <div className="flex flex-wrap items-center gap-2" role="group" aria-label="Controles de acessibilidade">
      <span className="text-xs font-bold uppercase tracking-wide text-slate-400">Acessibilidade</span>
      <button
        type="button"
