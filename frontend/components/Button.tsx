...
export default function Button({variant='primary', children, className='', ...props}:Props){
  ...
  const v = variant === 'primary'
    ...
    : 'border border-slate-500/50 bg-slate-950/72 text-slate-100 shadow-sm backdrop-blur hover:border-cyan-300/40 hover:bg-slate-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-300'
  return (
